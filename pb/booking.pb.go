...
const file_proto_booking_proto_rawDesc = "" +
	...
	"\x05Empty\"/\n" +
	"\bRoomList\x12#\n" +
	"\x05rooms\x18\x01 \x03(\v2\r.booking.RoomR\x05rooms\"Z\n" +
	...
	"\x0fGetRoomSchedule\x12\x1f.booking.GetRoomScheduleRequest\x1a\x1d.booking.RoomScheduleResponse\x12Z\n" +
...
var file_proto_booking_proto_depIdxs = []int32{
	...
	10, // 6: booking.BookingService.CancelReservation:input_type -> booking.CancelReservationRequest
	4,  // 7: booking.BookingService.Login:output_type -> booking.LoginResponse
	9,  // 8: booking.BookingService.GetRooms:output_type -> booking.RoomList
	2,  // 9: booking.BookingService.CreateReservation:output_type -> booking.ReservationResponse
	7,  // 10: booking.BookingService.GetRoomSchedule:output_type -> booking.RoomScheduleResponse
	11, // 11: booking.BookingService.CancelReservation:output_type -> booking.CancelReservationResponse
